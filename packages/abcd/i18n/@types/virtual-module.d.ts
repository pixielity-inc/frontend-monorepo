 ...
 *
 * Provides type information for the `virtual:@abdokouta/react-i18n` module
 ...
 * Define the virtual:@abdokouta/react-i18n module
 */
declare module 'virtual:@abdokouta/react-i18n' {
  /**
   ...
   * @example
   * ```typescript
   * import { __ } from 'virtual:@abdokouta/react-i18n';
   ...
   * @example
   * ```typescript
   * import { t } from 'virtual:@abdokouta/react-i18n';
   ...
   * @example
   * ```typescript
   * import { trans } from 'virtual:@abdokouta/react-i18n';
   ...
   * @example
   * ```typescript
   * import { i18n } from 'virtual:@abdokouta/react-i18n';
   ...
   * @example
   * ```typescript
   * import { changeLanguage } from 'virtual:@abdokouta/react-i18n';
   ...
   * @example
   * ```typescript
   * import { getLanguage } from 'virtual:@abdokouta/react-i18n';
   ...
   * @example
   * ```typescript
   * import { getLanguages } from 'virtual:@abdokouta/react-i18n';
   ...
   * @example
   * ```typescript
   * import { addResources } from 'virtual:@abdokouta/react-i18n';
