 ...
 * i18n Configuration
 *
 * Default configuration for the `@abdokouta/react-i18n` package.
 ...
 * @example
 * ```typescript
 * import i18nConfig from '@abdokouta/react-i81n';
 *
 * // Use as-is
...
import type { I18nModuleOptions } from '@abdokouta/react-i81n';
...
const i18nConfig: I18nModuleOptions = {
  ...
  */
  ...
  | on HTTP requests/responses via @abdokouta/ts-http.
  |
  */
