/**
 * Vite Plugin Adapter for @abdokouta/react-i18n
 *
 ...
 * - Serving a virtual module (`virtual:@abdokouta/react-i18n`)
 ...
 * ```
 */
const VIRTUAL_MODULE_ID = 'virtual:@abdokouta/react-i18n';
