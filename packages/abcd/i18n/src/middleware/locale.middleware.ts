 ...
 *
 * Integrates with the `@abdokouta/ts-http` middleware pipeline to:
 ...
 * request config.
 *
 * Uses the `@HttpMiddleware()` decorator from `@abdokouta/ts-http`
 ...
 * // Or manually:
 * import { LocaleMiddleware } from '@abdokouta/react-i18n';
 * import { I18N_CONFIG, I18NEXT_SERVICE } from '@abdokouta/react-i18n';
 *
 * @Module({
