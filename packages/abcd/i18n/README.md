<p align="center">
  <img src=".github/assets/banner.svg" alt="@abdokouta/react-i18n banner" width="900" />
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/@abdokouta/react-i18n">
    <img src="https://img.shields.io/npm/v/@abdokouta/react-i18n?style=flat-square&color=38bdf8&label=npm" alt="npm version" />
  </a>
  <a href="./LICENSE">
...
`@abdokouta/react-i18n` is a full-fledged internationalization system for
React + Vite projects. Built on **i18next**, it integrates with the
`@abdokouta/ts-container` DI system, the `@abdokouta/ts-http` middleware
...
```bash
pnpm add @abdokouta/react-i18n
```

**Peer dependencies:** `vite`, `@abdokouta/ts-container`, `@abdokouta/ts-http`
...
import { I18nModule } from '@abdokouta/react-i18n';
...
```tsx
import { ContainerProvider } from '@abdokouta/ts-container';
import { I18nProvider } from '@abdokouta/react-i18n';
...
```tsx
import { useTranslation } from '@abdokouta/react-i18n';
...
```tsx
import { useLocale } from '@abdokouta/react-i18n';
...
```tsx
import { useLocale, useChangeLocale } from '@abdokouta/react-i18n';
...
import { LocaleResolverPriority } from '@abdokouta/react-i18n';
...
The `LocaleMiddleware` integrates with `@abdokouta/ts-http`:
...
import { i18nPlugin } from '@abdokouta/react-i18n';
...
translation files, virtual module (`virtual:@abdokouta/react-i18n`).
