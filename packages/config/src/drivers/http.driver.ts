 ...
 * `@abdokouta/ts-http`'s `HttpClient`. Supports response transformation
...
import type { HttpClient, HttpResponse } from '@abdokouta/ts-http';
 ...
 *
 * Requires an `HttpClient` instance (from `@abdokouta/ts-http`) and
...
export class HttpDriver implements ConfigDriver {
   ...
   *
   * @param httpClient - The `HttpClient` instance from `@abdokouta/ts-http`
