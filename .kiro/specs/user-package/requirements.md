...
of AuthIdentity and Actor Types, adapted for Laravel's Eloquent + Sanctum ecosystem.
...
- Fields: first_name, last_name, phone, date_of_birth, gender, bio, address (JSON), social_links (JSON), preferences (JSON)
